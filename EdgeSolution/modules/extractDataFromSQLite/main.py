...
sql_statement = os.environ['SQL_STATEMENT'] if 'SQL_STATEMENT' in os.environ else 'SELECT * FROM mytable'
interval_sec = int(os.environ['INTERVAL_SEC']) if 'INTERVAL_SEC' in os.environ else 60
